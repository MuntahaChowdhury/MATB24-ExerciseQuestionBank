...
\begin{tcolorbox}
Let $J$ be any index set to enumerate the elements of another set. Let $\{W_\alpha\mid\alpha\in J\}$ be a collection of subspaces of $V$. Then $\bigcap\limits_{\alpha\in J} W_{\alpha}$ is a subspace of $V$.
\end{tcolorbox}
}
\begin{solution}
  % ==== Place for solution here ====
